...
function defineBookInfo () {
  ...
  BookInfo.encodingLength = encodingLength
  BookInfo.encode = encode
  BookInfo.decode = decode
  ...
  function encodingLength (obj) {
    ...
    if (defined(obj.author)) {
      var len = enc[1].encodingLength(obj.author)
      length += 1 + len
    }
    return length
  }
  ...
  function encode (obj, buf, offset) {
    ...
    if (defined(obj.author)) {
      buf[offset++] = 26
      enc[1].encode(obj.author, buf, offset)
      offset += enc[1].encode.bytes
    }
  ...
  function decode (buf, offset, end) {
    ...
    while (true) {
      ...
      switch (tag) {
        ...
        break
        case 3:
        obj.author = enc[1].decode(buf, offset)
        offset += enc[1].decode.bytes
        break
        default:
